export class Empleat {
  ...
  constructor(empleat_num: number, empleat_nom: string, empleat_ofici: string, empleat_dir: number, empleat_datalt: Date, empleat_salari: number, empleat_comissio: number, empleat_dept_num: number) {
